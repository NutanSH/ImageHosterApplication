...
public class ImageController {
    ...
    //First receive the dynamic parameter in the incoming request URL in a string variable 'title' and integer variable 'imageId' and also the Model type object
    ...
    //1.Image Upload Issue Fix : getImageByTitle() method is updated to pass the image id along with the title of the image to obtain a unique result
    ...
    //Issue Fix for Non-owner of the image able to edit the image, editImage method is modified to check the logged in User against the owner of the Image
